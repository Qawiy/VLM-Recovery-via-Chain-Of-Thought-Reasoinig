...
_BASE_INSTR = ("You are a top-down pick-and-place failure-diagnosis module viewing a "
               "downward eye-in-hand camera image. The image centre (crosshair) is where "
               "the gripper is aiming. Camera axes: +x = image right, +y = image up. "
               "The orange cube is the target object; report the offset in centimetres "
               "to ADD to the gripper's aim so it lands on the cube. "
